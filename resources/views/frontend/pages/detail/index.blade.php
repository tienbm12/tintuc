                ...
                <div class="main--content col-md-8" data-sticky-content="true">
                    <div class="sticky-content-inner">
                        ...
                        <div class="post--item post--single post--title-largest pd--30-0">
                            <div class="post--img">
                                <a href="#" class="thumb"><img src="/uploads/tintuc/{{ $tin->hinhanh }}"
                                        alt=""></a>
                                @if (Auth::check())
                                        ...
                                        <div class="post--item">
                                            <div class="post--img">
                                                <a href="{{ route('bai-viet',['slug'=>$ketiep->slug]) }}" class="thumb"><img
                                                        src="{{ url('/uploads')}}/tintuc/{{ $ketiep->hinhanh }}" alt=""></a>
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="{{ route('bai-viet',['slug'=>$li->slug]) }}" class="thumb"><img
                                                            src="uploads/tintuc/{{ $li->hinhanh }}" alt=""></a>
                                        ...
                                        <li>
                                            ...
                                            <div class="comment--item clearfix">
                                                <div class="comment--img float--left">
                                                    <img src="{{ url('/frontned') }}/img/news-single-img/comment-avatar-02.jpg" alt="">
                                                </div>
                                                ...
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $xuhuong->slug]) }}" class="thumb"><img
                                                                src="{{ url('/uploads')}}/tintuc/{{ $xuhuong->hinhanh }}"
                                                                alt=""></a>
                                                ...
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet', ['slug' => $luachon->slug]) }}"
                                                            class="thumb"><img
                                                                src="{{ url('/uploads')}}/tintuc/{{ $luachon->hinhanh }}"
                                                                alt=""></a>
