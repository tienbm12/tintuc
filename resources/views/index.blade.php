                                        ...
                                        <div class="post--item post--layout-1 post--title-large">
                                            <div class="post--img">
                                                <a href="{{ route('bai-viet',['slug'=>$f_f_e->slug]) }}" class="thumb"><img
                                                        src="{{ url('/uploads')}}/tintuc/{{ $f_f_e->hinhanh }}"alt="" ></a>
                                        ...
                                        <div class="post--item post--layout-1 post--title-larger">
                                            <div class="post--img">
                                                <a href="{{ route('bai-viet',['slug'=>$t_s_f->slug]) }}" class="thumb"><img
                                                        src="{{ url('/uploads')}}/tintuc/{{ $t_s_f->hinhanh }}" style="height:200px" alt=""></a>
                                ...
                                <div class="post--item post--layout-1 post--title-larger">
                                    <div class="post--img">
                                        <a href="{{ route('bai-viet',['slug'=>$e_t_z->slug]) }}" class="thumb"><img
                                                src="{{ url('/uploads')}}/tintuc/{{ $e_t_z->hinhanh }}" alt=""></a>
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet',['slug'=>$tg->slug]) }}" class="thumb"><img
                                                                src="{{ url('/uploads')}}/tintuc/{{ $tg->hinhanh }}"
                                                                alt=""></a>
                                                ...
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet',['slug'=>$the_gioi2->slug]) }}" class="thumb"><img
                                                                src="{{ url('/uploads')}}/tintuc/{{ $the_gioi2->hinhanh }}"
                                                                alt=""></a>
                                                ...
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet',['slug'=>$the_gioi3->slug]) }}" class="thumb"><img
                                                                src="{{ url('/uploads')}}/tintuc/{{ $the_gioi3->hinhanh }}"
                                                                alt=""></a>
                                                ...
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet',['slug'=>$cong_nghe->slug]) }}" class="thumb"><img
                                                                src="{{ url('/uploads')}}/tintuc/{{ $cong_nghe->hinhanh }}"
                                                                alt=""></a>
                                                ...
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet',['slug'=>$cong_nghe2->slug]) }}" class="thumb"><img
                                                                src="{{ url('/uploads')}}/tintuc/{{ $cong_nghe2->hinhanh }}"
                                                                alt=""></a>
                                                ...
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="{{ route('bai-viet',['slug'=>$giao_duc->slug]) }}" class="thumb"><img
                                                                src="{{ url('/uploads')}}/tintuc/{{ $giao_duc->hinhanh }}"
                                                                alt=""></a>
                                                        ...
                                                        <div class="post--item post--layout-2">
                                                            <div class="post--img">
                                                                <a href="{{ route('bai-viet',['slug'=>$giao_duc2->slug]) }}" class="thumb"><img
                                                                        src="{{ url('/uploads')}}/tintuc/{{ $giao_duc2->hinhanh }}"
                                                                        alt=""></a>
                                                        ...
                                                        <div class="post--item post--layout-2">
                                                            <div class="post--img">
                                                                <a href="{{ route('bai-viet',['slug'=>$giao_duc3->slug]) }}" class="thumb"><img
                                                                        src="{{ url('/uploads')}}/tintuc/{{ $giao_duc3->hinhanh }}"
                                                                        alt=""></a>
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="{{ route('bai-viet',['slug'=>$thethao->slug]) }}" class="thumb"><img
                                                            src="{{ url('/uploads')}}/tintuc/{{ $thethao->hinhanh }}"
                                                            alt=""></a>
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="{{ route('bai-viet',['slug'=>$khoahoc->slug]) }}" class="thumb"><img
                                                            src="{{ url('/uploads')}}/tintuc/{{ $khoahoc->hinhanh }}"
                                                            alt=""></a>
                            ...
                            <div class="post--item post--layout-1 post--type-video post--title-large">
                                <div class="post--img">
                                    <a href="{{ $video->video }}" class="thumb"><img
                                            src="{{ url('/uploads')}}/tintuc/{{ $video->hinhanh }}"
                                            alt=""></a>
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="{{ route('bai-viet',['slug'=>$doisong->slug]) }}" class="thumb"><img
                                                            src="{{ url('/uploads')}}/tintuc/{{ $doisong->hinhanh }}"
                                                            alt=""></a>
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="{{ route('bai-viet',['slug'=>$phapluat->slug]) }}" class="thumb"><img
                                                            src="{{ url('/uploads')}}/tintuc/{{ $phapluat->hinhanh }}"
                                                            alt=""></a>
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="{{ route('bai-viet',['slug'=>$giaitri->slug]) }}" class="thumb"><img
                                                            src="{{ url('/uploads')}}/tintuc/{{ $giaitri->hinhanh }}"
                                                            alt=""></a>
                                            ...
                                            <div class="post--item post--layout-1 post--title-large">
                                                <div class="post--img">
                                                    <a href="{{ route('bai-viet',['slug'=>$kinhte->slug]) }}" class="thumb"><img
                                                            src="{{ url('/uploads')}}/tintuc/{{ $kinhte->hinhanh }}"
                                                            alt=""></a>
